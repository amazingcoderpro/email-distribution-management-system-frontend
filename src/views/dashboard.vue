    ...
    <div class="dashboard">
        ...
        <div class="dataBox">
            ...
            <div class="dataBoxSon">
                ...
                <div class="content">{{echartData.topDashboard.avg_repeat_purchase_rate}}%</div>
            </div>
            <div class="dataBoxSon">
                <div class="title">Avg. Conversion Rate</div>
                <div class="content">{{echartData.topDashboard.avg_conversion_rate}}%</div>
            </div>
            <div class="dataBoxSon">
            ...
            <div class="dataBoxSon">
                ...
                <div class="content">{{echartData.topDashboard.avg_open_rate}}%</div>
            </div>
            <div class="dataBoxSon">
                <div class="title">Avg. Click Rate</div>
                <div class="content">{{echartData.topDashboard.avg_click_rate}}%</div>
            </div>
            <div class="dataBoxSon">
                <div class="title">Avg. Unsubscribe Rate</div>
                <div class="content">{{echartData.topDashboard.avg_unsubscribe_rate}}%</div>
            </div>
        </div>
    ...
    methods:{
            ...
            this.$axios.get(urlString).then(res => {
               // this.loadingState.dashboardFive = false;
                if(res.data.code==1){
                    ...
                    console.log(this.echartData.topDashboard)
                }else{
        ...
        init(){
            ...
            this.$axios.get(urlString).then(res => {
               // this.loadingState.dashboardFive = false;
                if(res.data.code==1){
                    this.echartData.bigArray = res.data.data;
                }else{
                    this.$message("Acquisition failure!");
                }
        ...
        echartTypeChange(){
            // echartData.echartType
            // Yvalue\
            this.Xvalue = [];
            this.Yvalue = [];
            // console.log(this.echartData.bigArray)
            this.echartData.bigArray.map(e => {
                this.Xvalue.unshift(base.dateFormat(e.create_time,"noyear"));
                this.Yvalue.unshift(e[this.echartData.echartType]);
            });
            this.initChart();
        }
    },
