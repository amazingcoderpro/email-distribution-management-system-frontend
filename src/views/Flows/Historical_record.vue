<template>
<div class="HistoricalRecord_title">
    ...
    export default {
        ...
        methods: {
            init() {
                ...
                let _url = `/api/v1/mail/history/?page=${this.page.currentPage}&page_size=${this.page.pagesize}&type=${1}&trigger_id=${this.RecordData.id}`;
...
.HistoricalRecord .titleClass{cursor: pointer;}
